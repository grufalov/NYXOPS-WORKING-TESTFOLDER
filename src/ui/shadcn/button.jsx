...
export function ShButton({ asChild = false, className = '', variant = 'default', size = 'md', ...props }) {
  ...
  const cls = [base, sizes[size] || sizes.md, variants[variant] || variants.default, className].join(' ').trim();
